...
**Files:**
- Modify: `docs/archive/v1.5/iterations/iteration-2026-07-12-report.md`
...
```powershell
git add -- AGENTS.override.md plugins/cgc-pms-autopilot/skills/cgc-pms-autopilot-owner/SKILL.md plugins/cgc-pms-autopilot/references/role-contracts.md plugins/cgc-pms-autopilot/templates/iteration-report-entry.md plugins/cgc-pms-autopilot/examples/iteration-report-entry.example.md scripts/codex-autopilot/test-tool-routing.ps1 docs/archive/v1.5/iterations/iteration-2026-07-12-report.md docs/archive/v1.5/plans/AutoPilot双图谱路由整改实施计划-2026-07-12.md
