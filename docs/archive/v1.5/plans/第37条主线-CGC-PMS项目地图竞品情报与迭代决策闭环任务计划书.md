...
| `docs/archive/v1.5/未来开发计划.md` | 只保留长期未完成方向和边界，不复制详细竞品资料 |
...
3. 核对 `docs/archive/v1.5/plans/README.md`、`docs/archive/v1.5/quality/README.md`、`docs/archive/v1.5/iterations/README.md`。
...
5. 更新 `docs/archive/v1.5/未来开发计划.md`，只保留长期方向和到决策记录的链接，删除重复叙述。
6. 形成 `docs/archive/v1.5/quality/mainline-37-product-intelligence-acceptance.md` 正式验收报告。
