...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-001-采购低库存补货建议最小闭环验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-002-供应商交付档案最小闭环验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-003-驾驶舱项目数据范围统一收口验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-004-分包WBS单前置FS依赖与延期风险验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-005-现场日报最小闭环验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-006-库存项安全库存阈值与补货建议联动验收报告.md`。
...
- 自动合并：本地 commit only；`autoPush=false`。
- 下一轮：继续产品情报刷新与候选补货；未命中 stop/pause。
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-007-现场日报天气摘要与在场人数补强验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-008-现场日报dev-login直达路由验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-009-库存项人工补货目标量联动验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-010-库存项人工补货提前期与计划日期预填验收报告.md`。
...
- 自动合并：本地 commit only；`autoPush=false`。
- 下一轮：继续产品情报刷新与候选补货；未命中 stop/pause。
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-011-现场日报已审批材料到货只读联动验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-012-现场日报当日计划任务只读联动验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-013-现场日报变更历史只读展示验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-017-BaseEntity备注写入契约修复验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-018-子智能体超时悬挂线程退役与有限重派治理验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-020-长期计划描述性标题误入候选修复验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-021-CI-CD与上线门禁v1.5复验报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-037-022-Windows-PowerShell-5.1-AutoPilot-脚本编码兼容修复验收报告.md`。
