# Ready Issue 历史归档：review-b8c59c337f3e49b8a81e770e3a3d85a4

- 回顾周期：`review-b8c59c337f3e49b8a81e770e3a3d85a4`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-047-003-日报Controller测试JWT密钥环境隔离修复验收报告.md`
...
- `docs/archive/v1.5/quality/ISSUE-047-003-日报Controller测试JWT密钥环境隔离修复验收报告.md`
禁止修改：
- `backend/src/main/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-052-日报人工天气摘要与在场人数契约回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-052-日报人工天气摘要与在场人数契约回归验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `scripts/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-053-供应商交付评分项目与空值边界回归验收报告.md`
最小回滚：仅回退本项治理文档与报告。
目标：
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-053-供应商交付评分项目与空值边界回归验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `scripts/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-054-现金日记账CSV公式注入与导出契约回归验收报告.md`
最小回滚：仅回退本项治理文档与报告。
目标：
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-054-现金日记账CSV公式注入与导出契约回归验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `scripts/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-055-站内通知租户用户隔离与已读幂等回归验收报告.md`
最小回滚：仅回退本项治理文档与报告。
目标：
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-055-站内通知租户用户隔离与已读幂等回归验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `scripts/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-047-002-V155双数据库迁移镜像与H2测试隔离验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-047-002-V155双数据库迁移镜像与H2测试隔离验收报告.md`
禁止修改：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-051-供应商默认提前期与采购订单交货日期预填验收报告.md`
...
- `docs/archive/v1.5/quality/ISSUE-040-051-供应商默认提前期与采购订单交货日期预填验收报告.md`
禁止修改：
- `backend/src/main/java/com/cgcpms/inventory/**`
- `backend/src/main/java/com/cgcpms/purchase/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-050-现场日报领料联动真实浏览器视觉回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-050-现场日报领料联动真实浏览器视觉回归验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `scripts/**`
...
执行复验结果（2026-07-16，主线程完成中风险真实浏览器复核）：
- 三项 health gate 经183秒稳定采样全部通过；当前 Vite 指向本 Issue worktree。日报前端专项1个文件7项测试与类型检查通过。
- 桌面1280×720与真实480×800窄视口均打开目标日报详情；140字施工内容可滚动读取，领料区只显示领料单号、物料、数量、单位、使用部位，真实领料行与专用空态分别通过，未出现价格、金额、合同、供应商或“已安装”。
- 窄视口弹窗宽480px、内容宽448px且关闭操作可见，控制台新增 error/warn 为0。验收夹具按 dev、localhost、重置标记三重门禁精确删除，数据库与页面复读均为零残留。
- OBS-DAILY-LOG-BROWSER 已关闭；新增后续项0、关闭后续项1、后续项净变化-1。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-049-WBS前置门禁错误单次提示与行为回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-049-WBS前置门禁错误单次提示与行为回归验收报告.md`
禁止修改：
- `backend/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-048-PowerShell7控制面与UTF8兼容回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-048-PowerShell7控制面与UTF8兼容回归验收报告.md`
禁止修改：
- `scripts/**`
- `plugins/**`
- `backend/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-047-WBS软删除墓碑事务故障注入回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-047-WBS软删除墓碑事务故障注入回归验收报告.md`
禁止修改：
- `backend/src/main/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-046-库存阈值与出库真实并发防覆盖回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-046-库存阈值与出库真实并发防覆盖回归验收报告.md`
禁止修改：
- `backend/src/main/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-045-补货设置权限项目与乐观锁负向回归验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-045-补货设置权限项目与乐观锁负向回归验收报告.md`
禁止修改：
- `backend/src/main/**`
- `frontend-admin/**`
- `scripts/codex-autopilot/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-044-驾驶舱性能测试阈值文案对齐验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-044-驾驶舱性能测试阈值文案对齐验收报告.md`
禁止修改：
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-OVERHEAD-DELETE`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=1688e2e5e1afda82bf26312d0b39ef693cd1e562
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-043-间接费规则受控删除入口与执行事实保护验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-043-间接费规则受控删除入口与执行事实保护验收报告.md`
禁止修改：
- `backend/src/main/resources/db/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-OVERHEAD-UPDATE`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=3b72fc0fa52364baeeaa9ef131f5b35e0319c298
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-042-间接费规则受控修改入口与字段状态边界验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-042-间接费规则受控修改入口与字段状态边界验收报告.md`
禁止修改：
- `backend/src/main/resources/db/**`
- `backend/src/main/java/com/cgcpms/overhead/entity/**`
- `backend/src/main/java/com/cgcpms/overhead/mapper/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-OVERHEAD-CREATE`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=81437003e6a827630266df4859aa5ee811ed82f3
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-041-间接费规则受控新建入口与科目租户边界验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-041-间接费规则受控新建入口与科目租户边界验收报告.md`
禁止修改：
- `backend/src/main/resources/db/**`
- `backend/src/main/java/com/cgcpms/overhead/entity/**`
- `backend/src/main/java/com/cgcpms/overhead/mapper/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-LOST`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=a5df9fe80a8e27f8e4d61d798a7002b69bc13b79
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-040-投标成本标记未中标入口与费用核销边界验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-040-投标成本标记未中标入口与费用核销边界验收报告.md`
禁止修改：
- `backend/src/main/**`
- `backend/src/main/resources/db/**`
- `frontend-admin/src/router/**`
...
状态：Done
来源锚点：`ISSUE-040-039` 收口实证；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-040-039-投标成本标记中标入口与状态项目边界验收报告.md`,`scripts/codex-autopilot/autopilot-closeout.ps1`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-047-001-AutoPilot收口区块边界与幂等误判验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-047-001-AutoPilot收口区块边界与幂等误判验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-WON`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=8dfa9ebfc8ba9dcd74ed0b8de2b066333d97c465
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-039-投标成本标记中标入口与状态项目边界验收报告.md`
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-039-投标成本标记中标入口与状态项目边界验收报告.md`
禁止修改：
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-DELETE`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=0d63f6739d0d2dcbc7610ec3c61e1bbc276ca7b0
存量问题键：[stock:A-01-BID-DELETE]
归档报告：`docs/archive/v1.5/quality/ISSUE-040-038-投标成本受控删除入口与状态租户边界验收报告.md`
Migration：需要
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-038-投标成本受控删除入口与状态租户边界验收报告.md`
禁止修改：
- `backend/src/main/java/**`
- `backend/src/main/resources/db/migration/V150__*`
- `backend/src/main/resources/db/migration/V151__*`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-UPDATE`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=0a801fb178c4a380bfb237d5b23ba65d5edca081
存量问题键：[stock:A-01-BID-UPDATE]
归档报告：`docs/archive/v1.5/quality/ISSUE-040-037-投标成本受控修改入口与状态租户边界验收报告.md`
Migration：需要
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-037-投标成本受控修改入口与状态租户边界验收报告.md`
禁止修改：
- `backend/src/main/resources/db/migration/V150__*`
- `backend/src/main/resources/db/migration/V151__*`
- `backend/src/main/resources/db/migration-h2/V150__*`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-PROJECT-ARCHIVE`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=688fc11553918cb2c25c46a9ae2dc83225a2a1af
存量问题键：[stock:A-01-PROJECT-ARCHIVE]
归档报告：`docs/archive/v1.5/quality/ISSUE-040-036-项目受控归档入口与项目数据范围验收报告.md`
Migration：不需要
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-036-项目受控归档入口与项目数据范围验收报告.md`
禁止修改：
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-OVERHEAD-LIST`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=5cec5beb458496888a7e62f6da76704a79b06cd1
存量问题键：[stock:A-01-OVERHEAD-LIST]
归档报告：`docs/archive/v1.5/quality/ISSUE-040-035-间接费规则只读列表入口与租户边界验收报告.md`
Migration：不需要
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-035-间接费规则只读列表入口与租户边界验收报告.md`
禁止修改：
- `backend/src/main/**`
- `backend/src/main/resources/db/migration/**`
- `frontend-admin/src/router/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-WORKFLOW-EFFICIENCY`；唯一问题载体 `docs/backlog/current-issues.json`；sourceRefs=`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=4365b297325c0b20528375a0e7f82449bfdae918
存量问题键：[stock:A-01-WORKFLOW-EFFICIENCY]
归档报告：`docs/archive/v1.5/quality/ISSUE-040-034-工作流个人效率统计只读入口与数据范围验收报告.md`
Migration：不需要
...
- `docs/backlog/current-focus.md`
- `docs/product-intelligence/project-map.md`
- `docs/archive/v1.5/quality/ISSUE-040-034-工作流个人效率统计只读入口与数据范围验收报告.md`
禁止修改：
- `backend/src/main/**`
- `backend/src/main/resources/db/migration/**`
- `backend/src/main/resources/db/migration-h2/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-DETAIL`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；候选证据基于当前 HEAD `d28d71a83a6709560166e028d64bf5b72a365ccd`。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-033-投标成本详情只读入口与租户边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-033-投标成本详情只读入口与租户边界验收报告.md`
禁止修改：
- `backend/src/main/**`
- `backend/src/test/java/com/cgcpms/bid/BidCostServiceTest.java`
- `frontend-admin/src/types/bid.ts`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-CREATE`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；候选证据基于当前 HEAD `163db3d0560ce3fca1c856601cee0e6d1025e0df`。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-032-投标成本受控新建入口与租户状态边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-032-投标成本受控新建入口与租户状态边界验收报告.md`
禁止修改：
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-COST-HISTORY`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-030-成本汇总历史只读入口与项目数据边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-030-成本汇总历史只读入口与项目数据边界验收报告.md`
禁止修改：
- `backend/src/main/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-BID-LIST`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；候选证据基于当前 HEAD `95767cb2e9203bdb4640a7df6ccb5556c72577b9`。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-031-投标成本只读列表入口与租户边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-031-投标成本只读列表入口与租户边界验收报告.md`
禁止修改：
- `backend/src/main/java/**`
- `frontend-admin/src/api/request.ts`
- `frontend-admin/src/stores/**`
...
状态：Done
来源锚点：项目知识图谱当前问题 `UI-ROLE-RESPONSIVE-TABLE-ZERO-HEIGHT`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-040-027-系统角色删除管理员入口与安全边界验收报告.md`；本轮又在 `ISSUE-040-028` 真实浏览器验收中稳定复现。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-029-共享列表中窄视口表格高度链修复验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-029-共享列表中窄视口表格高度链修复验收报告.md`
禁止修改：
...
状态：Done
来源锚点：项目知识图谱当前问题 `A-01-ROLE-UPDATE`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=e6ac6994b121a4eb980ef167dd6fdb59269bce59
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-028-系统角色修改管理员入口与安全边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-028-系统角色修改管理员入口与安全边界验收报告.md`
禁止修改：
...
状态：Done（2026-07-15）
来源锚点：项目知识图谱当前问题 `A-01-ROLE-DELETE`；正式唯一问题载体为 `docs/backlog/current-issues.json`，其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；candidateEvidenceHead=0e4f793ff48be77416da2f8672348c12f3896167
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-027-系统角色删除管理员入口与安全边界验收报告.md`
...
- `docs/product-intelligence/evolution-decision.md`
- `docs/iterations/**`
- `docs/archive/v1.5/quality/ISSUE-040-027-系统角色删除管理员入口与安全边界验收报告.md`
禁止修改：
- `backend/src/main/java/com/cgcpms/system/controller/**`
- `backend/src/main/java/com/cgcpms/system/entity/**`
- `backend/src/main/java/com/cgcpms/system/mapper/**`
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-027-系统角色删除管理员入口与安全边界验收报告.md`；新增后续项1（`UI-ROLE-RESPONSIVE-TABLE-ZERO-HEIGHT`）、关闭后续项1（`A-01-ROLE-DELETE`）、后续项净变化0。新项为既有响应式布局缺陷，不阻断本轮宽屏桌面管理员入口，已写入唯一台账，产品候选排序不变。
...
正式报告：`docs/archive/v1.5/quality/ISSUE-040-018-AutoPilot存量问题优先补货机制验收报告.md`。
...
正式报告：`docs/archive/v1.5/quality/ISSUE-040-017-知识图谱当前问题结构化查询验收报告.md`。
...
正式报告：`docs/archive/v1.5/quality/ISSUE-040-012-016-A-01财务核算五项入口治理验收报告.md`。
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-001-预警批量评估独立权限码修复验收报告.md`。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-022-Windows-PowerShell-5.1-AutoPilot-脚本编码兼容修复验收报告.md`
...
- `docs/product-intelligence/evolution-decision.md`
- `docs/iterations/**`
- `docs/archive/v1.5/quality/ISSUE-037-022-Windows-PowerShell-5.1-AutoPilot-脚本编码兼容修复验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `deploy/**`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-017-BaseEntity备注写入契约修复验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-016-WBS软删除编号冲突修复验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-015-WBS单前置FS开工门禁验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-014-现场日报当日已审批领料只读联动验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-013-现场日报变更历史只读展示验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-012-现场日报当日计划任务只读联动验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-011-现场日报已审批材料到货只读联动验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-005-现场日报最小闭环验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-009-库存项人工补货目标量联动验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-010-库存项人工补货提前期与计划日期预填验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-008-现场日报dev-login直达路由验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-007-现场日报天气摘要与在场人数补强验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-006-库存项安全库存阈值与补货建议联动验收报告.md`
目标：
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-018-子智能体超时悬挂线程退役与有限重派治理验收报告.md`
目标：
...
自动合并：auto-merge/local-commit-only
来源锚点：`docs/backlog/ad-hoc-plan.md` 的“后端接口无前端入口治理” Candidate；`docs/product-intelligence/project-map.md` 的现有能力可达性缺口；`docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-11-01` 候选决策卡；`docs/archive/v1.5/未来开发计划.md` 的“权限、租户、项目数据边界”验收边界
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`
...
允许修改：
- `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/backlog/ad-hoc-plan.md`
- `docs/backlog/current-focus.md`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-020-长期计划描述性标题误入候选修复验收报告.md`
...
- `docs/product-intelligence/evolution-decision.md`
- `docs/iterations/**`
- `docs/archive/v1.5/quality/ISSUE-037-020-长期计划描述性标题误入候选修复验收报告.md`
禁止修改：
- `backend/**`
- `frontend-admin/**`
- `deploy/**`
...
自动合并：auto-merge/local-commit-only
来源锚点：`docs/backlog/cgc-pms-production-enhancement-plan.md` 的 `7.1 P0-1：CI/CD 与上线门禁`；`docs/archive/v1.5/未来开发计划.md` 的“CI/CD 与上线门禁复验”；`docs/backlog/current-focus.md` 的 v1.0 证据不得直接作为 v1.5 验收证据约束
...
归档报告：`docs/archive/v1.5/quality/ISSUE-037-021-CI-CD与上线门禁v1.5复验报告.md`
...
允许修改：
- `docs/archive/v1.5/quality/ISSUE-037-021-CI-CD与上线门禁v1.5复验报告.md`
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/backlog/ready-issues.md`
- `docs/backlog/blocked-issues.md`
...
- 正式证据：`docs/archive/v1.5/quality/ISSUE-037-021-CI-CD与上线门禁v1.5复验报告.md`。
...
状态：Done
来源锚点：`docs/backlog/current-issues.json` 的 `A-01-MENU-CREATE`；`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；`docs/product-intelligence/project-map.md`；`docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-13-02` 与“后端接口无前端入口治理”决策卡
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-019-系统菜单新建管理员入口验收报告.md`
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-019-系统菜单新建管理员入口验收报告.md`；新增后续项0、关闭后续项1（`A-01-MENU-CREATE`）、后续项净变化-1。
...
状态：Done
来源锚点：`docs/backlog/current-issues.json` 的 `A-01-MENU-DELETE`；`docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；`docs/product-intelligence/project-map.md`；`docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-13-02` 与“后端接口无前端入口治理”决策卡
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-020-系统菜单删除管理员入口验收报告.md`
...
- `docs/archive/v1.5/quality/ISSUE-040-020-系统菜单删除管理员入口验收报告.md`
禁止修改：
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-020-系统菜单删除管理员入口验收报告.md`；新增后续项0、关闭后续项1（`A-01-MENU-DELETE`）、后续项净变化-1。
...
状态：Done
来源锚点：`docs/backlog/current-issues.json` 的 `A-01-MENU-DETAIL`；其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；并引用 `docs/product-intelligence/project-map.md` 与 `docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-13-02`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-021-系统菜单详情管理员入口验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-021-系统菜单详情管理员入口验收报告.md`
禁止修改：
- `backend/src/main/java/com/cgcpms/system/controller/SysMenuController.java`
- `backend/src/main/java/com/cgcpms/system/service/SysMenuService.java`
- `backend/src/main/java/com/cgcpms/system/entity/**`
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-021-系统菜单详情管理员入口验收报告.md`；新增后续项0、关闭后续项1（`A-01-MENU-DETAIL`）、后续项净变化-1。
...
状态：Done
来源锚点：`docs/backlog/current-issues.json` 的 `A-01-MENU-LIST`；其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；并引用 `docs/product-intelligence/project-map.md` 与 `docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-13-02`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-022-系统菜单平铺列表管理员入口验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-022-系统菜单平铺列表管理员入口验收报告.md`
禁止修改：
- `backend/src/main/**`
- `backend/src/main/resources/db/migration/**`
- `backend/src/main/resources/db/migration-h2/**`
...
状态：Done
来源锚点：`docs/backlog/current-issues.json` 的 `A-01-MENU-UPDATE`；其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；并引用 `docs/product-intelligence/project-map.md` 与 `docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-13-02`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-023-系统菜单修改管理员入口验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-023-系统菜单修改管理员入口验收报告.md`
禁止修改：
- `backend/src/main/java/com/cgcpms/system/controller/SysMenuController.java`
- `backend/src/main/java/com/cgcpms/system/entity/**`
- `backend/src/main/java/com/cgcpms/system/mapper/**`
...
状态：Done
来源锚点：正式唯一问题载体 `docs/backlog/current-issues.json` 的 `A-01-OVERHEAD-EXECUTE`；其 `sourceRefs` 为 `docs/archive/v1.5/quality/ISSUE-037-019-后端接口无前端入口只读盘点与治理裁决验收报告.md`；并引用 `docs/product-intelligence/project-map.md` 与 `docs/product-intelligence/evolution-decision.md` 的 `PI-2026-07-13-02`
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-024-间接费执行分摊用户入口与金额安全边界验收报告.md`
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-024-间接费执行分摊用户入口与金额安全边界验收报告.md`。新增后续项0、关闭后续项1（`A-01-OVERHEAD-EXECUTE`）、后续项净变化-1；未新增阻塞项，独立 Reviewer 已对绑定 diff 给出 `PASS`，发现项0。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-025-系统角色新建管理员入口与权限边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-025-系统角色新建管理员入口与权限边界验收报告.md`
禁止修改：
- `backend/src/main/java/com/cgcpms/system/controller/**`
- `backend/src/main/java/com/cgcpms/system/entity/**`
- `backend/src/main/java/com/cgcpms/system/mapper/**`
...
- 正式报告：`docs/archive/v1.5/quality/ISSUE-040-025-系统角色新建管理员入口与权限边界验收报告.md`。新增后续项0、关闭后续项1（`A-01-ROLE-CREATE`）、后续项净变化-1；未新增阻塞项。
...
归档报告：`docs/archive/v1.5/quality/ISSUE-040-026-系统角色详情管理员入口与权限边界验收报告.md`
...
- `docs/product-intelligence/project-map.md`
- `docs/product-intelligence/evolution-decision.md`
- `docs/archive/v1.5/quality/ISSUE-040-026-系统角色详情管理员入口与权限边界验收报告.md`
禁止修改：
- `backend/src/main/java/**`
- `backend/src/main/resources/db/migration/**`
- `backend/src/main/resources/db/migration-h2/**`
