...
- 当前有 4 条合格 Ready：`ISSUE-008-026`、`ISSUE-008-027`、`ISSUE-008-028`、`ISSUE-008-029`。
- `ISSUE-008-022`、`ISSUE-008-023`、`ISSUE-008-024`、`ISSUE-008-025` 已完成并转 Done；`ISSUE-008-023` 已于 2026-07-10 完成正式收口并计入本轮第 `4/10` 个实施型 Ready Issue。
...
1. 默认先执行 `ISSUE-008-026`，补齐 WBS 只读甘特真实渲染与降级态验收证据。
2. `ISSUE-008-026` 依赖的 `ISSUE-008-023` 已完成；`ISSUE-008-027` 依赖的 `ISSUE-008-025` 已完成，可与 WBS 链路串行错峰。
