...
## 2026-08-04 主线69：项目立项、主合同与开工准入闭环整改计划

- 唯一问题源：`ISSUE-069-001`；状态 `OPEN / P0 / PLAN_READY / IMPLEMENTATION_NOT_AUTHORIZED`。
...
- 计划：[`第69条主线`](../plans/第69条主线-项目立项主合同与开工准入闭环整改任务计划书.md)。
