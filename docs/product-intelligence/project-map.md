...
## 2026-07-17 候选：现场日报当日质量安全检查只读联动

- 日报详情已聚合当日到货、已审批出库领料、计划/WBS和变更历史；质量安全域已具备项目、检查日期、提交状态、结论及问题严重程度/状态，但两者尚未连接。
- 最小切片新增独立只读聚合，不把质量安全字段塞入日报主表；权限取日报查询与质量安全查询交集，客户端不能传项目/日期扩大范围。
