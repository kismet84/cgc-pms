...
- 验证：迁移前碰撞预检零行，H2 active/legacy、MySQL V280空库及V180→V280升级、真实开工附件链、刷新后合同页回读及69,270字节八列元数据映射隔离恢复通过；`REL-FILE-RESCAN`保持独立目标环境发布门。
