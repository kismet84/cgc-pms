...
| 供应商退供及库存/成本/预算反向冲销    | `supplierreturn/service/SupplierReturnService.java`、`V182__create_supplier_return_closed_loop.sql`                                                          |
...
| 关键主链自动化验证                    | `PurchaseRequestServiceTest`、`MatPurchaseOrderServiceTest`、`SupplierReturnServiceTest`、`ProcurementIntegrityServiceTest`、前端采购/验收/领料闭环测试      |
