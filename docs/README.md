...
最新主线：第100条“MySQL TLS 信任链与依赖安全整改”采用 MySQL 8.4.12 / Connector/J 26.7.0，G0～G4通过：精确镜像安全、隔离恢复、完整Push CI及新组合真实登录、合作方样本列表/详情、API与数据库回读已验证。G5最终证据SHA、受保护合并、post-merge及安全清理仍待完成，唯一载体 `ISSUE-100-001` 保持开放。状态、计划与验收分别见[当前 Backlog](backlog/current-focus.md)、[第100条计划](plans/第100条主线-MySQL TLS信任链与依赖安全整改任务计划书.md)和[质量报告](quality/2026-08-30-issue-100-MySQL-TLS信任链与依赖安全整改.md)。
