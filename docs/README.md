...
最新主线：第100条“MySQL TLS 信任链与依赖安全整改”的 M6 已批准实施，采用 MySQL 8.4.12 / Connector/J 26.7.0；候选隔离恢复已验证，精确镜像安全绑定及新组合完整 G2～G5 正在复验，功能分支已推送，尚未合并；唯一载体 `ISSUE-100-001` 保持开放。旧组合 TLS/浏览器记录不替代新组合验收。状态、计划与验收分别见[当前 Backlog](backlog/current-focus.md)、[第100条计划](plans/第100条主线-MySQL TLS信任链与依赖安全整改任务计划书.md)和[质量报告](quality/2026-08-30-issue-100-MySQL-TLS信任链与依赖安全整改.md)。
