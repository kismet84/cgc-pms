...
最新主线：第89条已由 PR #430、#431 完成受保护交付；第90条整体仍为计划状态，仅其第91条财务查询性能依赖批次获本轮授权；第91条正在独立分支 `codex/mainline-91-architecture-query-performance` 实施。当前远端基线为 `origin/master@e1b7adb2`；状态、计划和证据分别以 Backlog、计划书及对应入口为准。
...
- [飞书幻灯片 Skill](../.agents/skills/lark-slides/SKILL.md)
