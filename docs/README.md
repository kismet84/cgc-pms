...
最新主线：第100条“MySQL TLS 信任链与依赖安全整改”G0～G5通过，采用MySQL8.4.12/ConnectorJ26.7.0。PR #465已合并，post-merge与任务清理核验通过，`ISSUE-100-001`关闭；现有dev库未升级。状态、计划与验收见[当前 Backlog](backlog/current-focus.md)、[第100条计划](plans/第100条主线-MySQL TLS信任链与依赖安全整改任务计划书.md)和[质量报告](quality/2026-08-30-issue-100-MySQL-TLS信任链与依赖安全整改.md)。
