...
export interface CloseoutStageGates {
  constructionCompletion: CloseoutGateBlocker[];
  warrantyEntry: CloseoutGateBlocker[];
  finalClose: CloseoutGateBlocker[];
}
...
export const CLOSEOUT_API = {
  ...
  confirmSectionAcceptance: (id: string) =>
    `/project-closeouts/section-acceptances/${id}/confirm`,
  finalAcceptance: (id: string) => `/project-closeouts/${id}/final-acceptance`,
  submitFinalAcceptance: (id: string) =>
    `/project-closeouts/final-acceptances/${id}/submit`,
  finalSettlement: (id: string) => `/project-closeouts/${id}/final-settlement`,
  verifyTailCollection: (id: string) =>
    `/project-closeouts/${id}/verify-tail-collection`,
  ...
  releaseWarranty: (id: string) =>
    `/project-closeouts/warranties/${id}/release`,
  archiveTransfer: (id: string) => `/project-closeouts/${id}/archive-transfer`,
  acceptArchiveTransfer: (id: string) =>
    `/project-closeouts/archive-transfers/${id}/accept`,
