...
| CT-004 | 新建合同基础信息 | P1 | CT-001、PM-001、PARTNER-001 | 可保存合同草稿 | 🔲 待开发 |
| CT-005 | 合同清单保存 | P1 | CT-004 | 可保存合同清单 | 🔲 待开发 |
| CT-006 | 合同付款条件保存 | P1 | CT-004 | 可保存付款条件 | 🔲 待开发 |
| CT-007 | 合同附件关联 | P1 | FILE-001 | 可上传并关联合同附件 | 🔲 待开发 |
