...
class SupplierSourcingClosedLoopIntegrationTest {
    ...
    void setup() {
        ...
        jdbc.update("INSERT INTO stl_settlement(id,tenant_id,project_id,contract_id,partner_id,settlement_code,settlement_type,contract_amount,change_amount,measured_amount,deduction_amount,paid_amount,final_amount,approval_status,status,settlement_status,created_by,created_at,updated_by,updated_at,deleted_flag) VALUES(?,0,?,?,?,'ST-SP-IT','PURCHASE',10000,0,10000,100,0,9900,'APPROVED','APPROVED','FINALIZED',1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0)", SETTLEMENT, PROJECT, CONTRACT, SUPPLIER_A);
    }
