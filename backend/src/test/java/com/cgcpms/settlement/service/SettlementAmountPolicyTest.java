...
class SettlementAmountPolicyTest {
    ...
    void calculatesTheAuthoritativeSettlementSnapshot() {
        ...
        assertEquals(new BigDecimal("250.00"), snapshot.finalAmount());
        assertEquals(new BigDecimal("12.50"), snapshot.warrantyAmount());
        assertEquals(new BigDecimal("-62.50"), snapshot.unpaidAmount());
    ...
    void normalizesNullsAndRoundsOnlyAtTheMoneyBoundary() {
        ...
        assertEquals(new BigDecimal("0.00"), snapshot.finalAmount());
        assertEquals(new BigDecimal("0.00"), snapshot.warrantyAmount());
        assertEquals(new BigDecimal("0.00"), snapshot.unpaidAmount());
    }
}
