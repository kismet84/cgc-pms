...
class ProjectBudgetConcurrencyTest {
    ...
    @BeforeEach void setup() {
        ...
        jdbc.update("INSERT INTO project_budget(id,tenant_id,project_id,budget_code,version_no,budget_name,total_amount,approval_status,status,active_flag,version,created_by,created_at,updated_by,updated_at,deleted_flag) VALUES(?,0,?,'BUD-20260725-901','V1','并发预算',1000,'DRAFT','DRAFT',0,0,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0)", BUDGET, PROJECT);
