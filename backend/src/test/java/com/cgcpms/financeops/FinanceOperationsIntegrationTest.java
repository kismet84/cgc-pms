...
class FinanceOperationsIntegrationTest {
    ...
    void seed() {
        ...
        jdbc.update("INSERT INTO project_budget(id,tenant_id,project_id,budget_code,version_no,budget_name,total_amount,approval_status,status,active_flag,active_token,effective_at,version,created_at,updated_at,deleted_flag) VALUES(?,0,?,'BUD-20260725-902','V1','测试预算',1000,'APPROVED','ACTIVE',1,?,CURRENT_TIMESTAMP,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,0)",BUDGET,PROJECT,PROJECT);
        ...
        jdbc.update("INSERT INTO fund_account(id,tenant_id,account_code,account_name,account_type,accounting_subject_code,opening_date,opening_balance,enabled_flag,version,created_at,updated_at,deleted_flag) VALUES(?,0,'FINOPS-A1','账户1','BANK','1002.02',CURRENT_DATE,1000,1,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,0)",ACCOUNT1);
        jdbc.update("INSERT INTO fund_account(id,tenant_id,account_code,account_name,account_type,accounting_subject_code,opening_date,opening_balance,enabled_flag,version,created_at,updated_at,deleted_flag) VALUES(?,0,'FINOPS-A2','账户2','BANK','1002.02',CURRENT_DATE,1000,1,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,0)",ACCOUNT2);
