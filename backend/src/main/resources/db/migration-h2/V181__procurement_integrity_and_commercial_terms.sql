...
ALTER TABLE mat_purchase_request_item ADD COLUMN sub_task_id BIGINT;
...
CREATE INDEX idx_mpr_item_sub_task ON mat_purchase_request_item (tenant_id, sub_task_id, deleted_flag);
...
ALTER TABLE mat_purchase_request_item ADD CONSTRAINT fk_mpr_item_sub_task
    FOREIGN KEY (sub_task_id) REFERENCES sub_task (id);
