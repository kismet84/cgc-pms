-- V125__add_missing_dict_types.sql (H2)
-- 新增缺失的字典类型，覆盖后端硬编码常量
...
(1016, 0, 'cost_target_status',   '成本目标状态',       'ENABLE'),
(1017, 0, 'purchase_order_status','采购订单状态',       'ENABLE'),
(1018, 0, 'purchase_request_status','采购申请状态',     'ENABLE'),
(1019, 0, 'sub_measure_status',   '分包计量状态',       'ENABLE');
...
-- 2.9 成本目标状态 (cost_target_status)
INSERT INTO sys_dict_data (id, tenant_id, dict_type_id, dict_label, dict_value, list_class, order_num, status) VALUES
(101601, 0, 1016, '草稿',   'DRAFT',     'default', 1, 'ENABLE'),
(101602, 0, 1016, '已生效', 'ACTIVE',    'success', 2, 'ENABLE'),
(101603, 0, 1016, '已作废', 'CANCELLED', 'danger',  3, 'ENABLE');

-- 2.10 采购订单状态 (purchase_order_status)
INSERT INTO sys_dict_data (id, tenant_id, dict_type_id, dict_label, dict_value, list_class, order_num, status) VALUES
(101701, 0, 1017, '草稿',   'DRAFT',     'default', 1, 'ENABLE'),
(101702, 0, 1017, '审批中', 'APPROVING', 'warning', 2, 'ENABLE'),
(101703, 0, 1017, '履行中', 'PERFORMING','primary', 3, 'ENABLE'),
(101704, 0, 1017, '已完成', 'COMPLETED', 'success', 4, 'ENABLE'),
(101705, 0, 1017, '已取消', 'CANCELLED', 'danger',  5, 'ENABLE');

-- 2.11 采购申请状态 (purchase_request_status)
INSERT INTO sys_dict_data (id, tenant_id, dict_type_id, dict_label, dict_value, list_class, order_num, status) VALUES
(101801, 0, 1018, '草稿', 'DRAFT',     'default', 1, 'ENABLE'),
(101802, 0, 1018, '已转PO','CONVERTED','primary', 2, 'ENABLE');

-- 2.12 分包计量状态 (sub_measure_status)
INSERT INTO sys_dict_data (id, tenant_id, dict_type_id, dict_label, dict_value, list_class, order_num, status) VALUES
(101901, 0, 1019, '草稿',   'DRAFT',     'default', 1, 'ENABLE'),
(101902, 0, 1019, '审批中', 'APPROVING', 'warning', 2, 'ENABLE'),
(101903, 0, 1019, '已确认', 'CONFIRMED', 'primary', 3, 'ENABLE'),
(101904, 0, 1019, '已完成', 'COMPLETED', 'success', 4, 'ENABLE');
