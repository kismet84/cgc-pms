-- Reconcile permission and retired cost-subject facts across fresh database dialects.
...
ON DUPLICATE KEY UPDATE
    menu_name = VALUES(menu_name), parent_id = VALUES(parent_id), menu_type = VALUES(menu_type),
    perms = VALUES(perms), status = VALUES(status), visible = VALUES(visible), updated_at = CURRENT_TIMESTAMP;
