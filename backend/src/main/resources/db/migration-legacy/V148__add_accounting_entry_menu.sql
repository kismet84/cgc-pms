...
VALUES
    (960, 0, 906, '会计凭证', 'MENU', '/accounting-entry', 'accounting-entry/index', 'accounting:query', 'account-book', 5, 'ENABLE', 1),
    (961, 0, 960, '过账与冲销', 'BUTTON', NULL, NULL, 'accounting:edit', NULL, 1, 'ENABLE', 0);
