...
-- Existing materials predate the category model. Give every tenant an explicit governed fallback
-- instead of leaving category_id as an unclassified null with ambiguous meaning.
