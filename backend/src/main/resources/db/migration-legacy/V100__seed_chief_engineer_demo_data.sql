...
SELECT
    ...
    NOW(), DATE_ADD(NOW(), INTERVAL 3 DAY), NULL, NULL, 1, 1, 0, 'chief-engineer demo seed v100'
FROM (
    SELECT COALESCE(
...
SELECT
    ...
    NOW(), DATE_ADD(NOW(), INTERVAL 2 DAY), NULL, NULL, 1, 1, 0, 'chief-engineer demo seed v100'
FROM (
    SELECT COALESCE(
        (SELECT id FROM pm_project WHERE tenant_id = 0 AND id = 2071032241708793858 AND deleted_flag = 0 LIMIT 1),
        (SELECT id FROM pm_project WHERE tenant_id = 0 AND id = 10001 AND deleted_flag = 0 LIMIT 1),
...
SELECT
    ...
    NOW(), DATE_ADD(NOW(), INTERVAL 1 DAY), NULL, NULL, 1, 1, 0, 'chief-engineer demo seed v100'
FROM (
    SELECT COALESCE(
        (SELECT id FROM pm_project WHERE tenant_id = 0 AND id = 2071032241708793858 AND deleted_flag = 0 LIMIT 1),
        (SELECT id FROM pm_project WHERE tenant_id = 0 AND id = 10001 AND deleted_flag = 0 LIMIT 1),
...
SELECT
    ...
    DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL, 1, 1, 0, 'chief-engineer demo seed v100'
FROM (
    SELECT COALESCE(
        (SELECT id FROM pm_project WHERE tenant_id = 0 AND id = 2071032241708793858 AND deleted_flag = 0 LIMIT 1),
        (SELECT id FROM pm_project WHERE tenant_id = 0 AND id = 10001 AND deleted_flag = 0 LIMIT 1),
