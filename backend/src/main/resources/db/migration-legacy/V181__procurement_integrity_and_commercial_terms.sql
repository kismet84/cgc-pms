...
ALTER TABLE mat_purchase_request_item
    ...
    ADD COLUMN sub_task_id BIGINT NULL COMMENT '分包任务ID' AFTER budget_line_id,
...
ALTER TABLE mat_purchase_request_item
    ...
    ADD CONSTRAINT fk_mpr_item_sub_task FOREIGN KEY (sub_task_id) REFERENCES sub_task (id) ON DELETE RESTRICT;
