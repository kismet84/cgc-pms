-- V130 H2: register MATERIAL_REQUISITION create permission for dev/super-admin test data setup.
...
SELECT 919, 0, 917, '新增领料申请', 'BUTTON', NULL, NULL, 'requisition:add', NULL, 2, 'ENABLE', 1
WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE id = 919);
