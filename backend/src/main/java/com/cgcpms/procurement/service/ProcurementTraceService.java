...
public class ProcurementTraceService {
    ...
    private final SupplierReturnItemMapper supplierReturnItemMapper;
    ...
    public ProcurementTraceVO bySupplierReturn(Long returnId) {
        Long tenantId = UserContext.getCurrentTenantId();
        SupplierReturn supplierReturn = supplierReturnMapper.selectById(returnId);
        ...
        List<SupplierReturnItem> items = supplierReturnItemMapper.selectList(
                new LambdaQueryWrapper<SupplierReturnItem>()
                        .eq(SupplierReturnItem::getTenantId, tenantId)
