...
public class MatPurchaseRequestController {
    ...
    @GetMapping
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('purchase:request:list')")
    ...
    @PostMapping
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('purchase:request:add')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('purchase:request:edit')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('purchase:request:delete')")
    ...
    @PreAuthorize("hasAuthority('purchase:request:submit') or hasRole('ADMIN')")
