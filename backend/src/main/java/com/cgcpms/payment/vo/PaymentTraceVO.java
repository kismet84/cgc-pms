...
public class PaymentTraceVO {
    ...
    private ContractBudgetAllocation contractBudgetAllocation;
    private ProjectBudget projectBudget;
    private ProjectBudgetLine projectBudgetLine;
    private CostSubject costSubject;
    private List<MatReceiptItem> materialReceiptItems;
    private List<MatReceipt> materialReceipts;
    private Map<String, String> budgetConservation;
