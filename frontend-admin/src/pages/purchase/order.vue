  ...
  <div class="project-target-redesign app-page">
    <div class="pt-page-head">
      <a-breadcrumb class="pt-breadcrumb"
        ...
        ><a-breadcrumb-item>采购订单</a-breadcrumb-item></a-breadcrumb
      >
    ...
    <div class="pt-kpi-strip">
      <div class="pt-kpi">
        <div class="pt-kpi-label">采购订单数</div>
        <div class="pt-kpi-value">{{ kpiOrderTotal }}<small>条</small></div>
      </div>
      <div class="pt-kpi">
        <div class="pt-kpi-label">待审批</div>
        <div class="pt-kpi-value">{{ kpiOrderPending }}<small>条</small></div>
      </div>
      <div class="pt-kpi">
        <div class="pt-kpi-label">已下单金额</div>
        <div class="pt-kpi-value">{{ kpiOrderedAmount.toLocaleString() }}<small>元</small></div>
      </div>
      <div class="pt-kpi">
        <div class="pt-kpi-label">未入库金额</div>
        <div class="pt-kpi-value" style="color: #f59e0b">
          {{ kpiUnreceived.toLocaleString() }}<small>元</small>
        </div>
      </div>
    </div>
    ...
    <div class="pt-ledger-layout">
      ...
      <aside class="pt-analysis-rail">
        <section class="pt-panel">
          <div class="pt-panel-header">订单状态分布</div>
          <div class="pt-panel-body">
            <ul class="pt-compact-list">
              <li v-for="it in orderStatusBreakdown" :key="it.label" class="pt-compact-row">
                <span>{{ it.label }}</span
                ><b>{{ it.count }} 条</b>
              </li>
            </ul>
