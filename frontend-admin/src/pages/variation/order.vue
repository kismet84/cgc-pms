  ...
  <div class="pm-page">
    ...
    <div class="pm-card pm-filter">
      <div class="pm-filter-row">
        ...
        <div class="pm-field">
          <label>变更类型：</label>
          <a-select v-model:value="filter.varType" placeholder="全部" allow-clear style="width:120px">
        ...
        <div class="pm-field">
          <label>方向：</label>
          <a-select v-model:value="filter.direction" placeholder="全部" allow-clear style="width:90px">
            <a-select-option
        ...
        <div class="pm-field">
          <label>变更编号：</label>
          <a-input v-model:value="filter.varCode" placeholder="请输入编号" style="width:150px" allow-clear />
        </div>
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'direction'">
            <a-tag :color="record.direction === 'COST' ? 'blue' : 'green'">
              {{ record.direction === 'COST' ? '成本' : record.direction === 'REVENUE' ? '收入' : (record.direction || '-') }}
            </a-tag>
          </template>
          ...
          <template v-else-if="column.key === 'confirmedAmount'">
            <span v-if="record.confirmedAmount">¥{{ Number(record.confirmedAmount).toLocaleString('zh-CN', { minimumFractionDigits: 2 }) }}</span>
            <span v-else class="pm-none">-</span>
          </template>
