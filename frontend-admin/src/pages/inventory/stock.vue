        ...
        <div v-if="!isMobile" class="lg-kpi-strip">
          <div class="lg-kpi-card">
            ...
            <span class="lg-kpi-card-value"
              >{{ kpiStockValue }} <small>{{ stock?.unit || '' }}</small></span
            >
          ...
          <div class="lg-kpi-card is-warn">
            ...
            <span class="lg-kpi-card-bar"
              ><span
                :style="{
                  width: lowStockWarn.length ? '100%' : '0%',
          ...
          <div class="lg-kpi-card">
            ...
            <span class="lg-kpi-card-bar"
              ><span style="width: 100%; background: var(--kpi-unpaid)"></span
            ></span>
          </div>
        </div>
            ...
            <a-descriptions :column="2" size="small" bordered>
              ...
              <a-descriptions-item label="变动量">
                ...
                >
                  {{ detailItem.txnType === 'OUT' ? '−' : '+'
                    ...
                    Number(detailItem.quantity).toLocaleString('zh-CN', {
              ...
              <a-descriptions-item label="变动后余量">
                <span style="font-weight: 600">
                  {{
                    Number(detailItem.availableAfter).toLocaleString('zh-CN', {
                      minimumFractionDigits: 4,
                    })
                  }}
                </span>
            ...
            <div v-for="w in lowStockWarn" :key="w.name" class="lg-type-row">
              ...
              <span class="lg-type-bar-wrap">
                <span
                  class="lg-type-bar"
                  :style="{
                    width: Math.min(100, (Number(w.qty) / 10) * 100) + '%',
            ...
            <div class="lg-type-row">
              ...
              <span class="lg-type-bar-wrap">
                <span
                  ...
                  :style="{
                    width:
                      kpiTxnIn + kpiTxnOut > 0
                        ? Math.round((kpiTxnIn / (kpiTxnIn + kpiTxnOut)) * 100) + '%'
                        : '0%',
                    background: '#22c55e',
                  }"
                ></span>
              ...
              <span class="lg-type-bar-wrap">
                <span
                  ...
                  :style="{
                    width:
                      kpiTxnIn + kpiTxnOut > 0
                        ? Math.round((kpiTxnOut / (kpiTxnIn + kpiTxnOut)) * 100) + '%'
                        : '0%',
                    background: '#ef4444',
                  }"
                ></span>
