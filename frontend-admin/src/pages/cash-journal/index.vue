  ...
  <div class="lg-page app-page cash-journal-page">
    ...
    <details class="cash-journal-filters" open>
      ...
      <div class="filter-grid">
        ...
        <select v-if="canQueryContract" v-model="filter.contractId" data-testid="contract-filter">
    ...
    <section class="cash-journal-table-card">
      <div class="table-heading">
        <strong>收支流水</strong
        ><a-button size="small" @click="loadRows"><ReloadOutlined />刷新</a-button>
      </div>
...
.cash-journal-header h1 {
  margin: 0;
  font-size: 24px;
}
.cash-journal-header p {
  margin: 5px 0 0;
  color: #667085;
}
.cash-journal-primary-actions {
  display: flex;
  flex-wrap: wrap;
...
.cash-journal-kpis article {
  display: grid;
  gap: 6px;
  padding: 16px;
  border-right: 1px solid #eaecf0;
}
.cash-journal-kpis article:last-child {
  border-right: 0;
}
.cash-journal-kpis span {
  color: #667085;
  font-size: 13px;
}
.cash-journal-kpis strong {
  font-size: 22px;
}
.kpi-income strong {
  color: #087a55;
...
.cash-journal-table-card :deep(.ant-pagination) {
  justify-content: flex-end;
  margin-top: 14px;
}
...
@media (max-width: 440px) {
  ...
  .cash-journal-primary-actions :deep(.ant-btn) {
    flex: 1 1 132px;
  }
  .cash-journal-kpis {
