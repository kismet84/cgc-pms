...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/technical-management', label: '图纸RFI技术闭环', permission: 'technical:query' },
      { key: '/project-closeout', label: '项目竣工收尾', permission: 'closeout:query' },
  ...
  },
  {
    ...
    matchPrefixes: ['/purchase', '/inventory', '/supplier-sourcing'],
    children: [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/cash-forecast', label: '项目资金预测', permission: 'finance:forecast:query' },
      { key: '/financial-close', label: '财务核算与月结', permission: 'finance:close:query' },
