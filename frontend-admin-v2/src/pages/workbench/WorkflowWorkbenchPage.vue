...
const approvalDetailLabels: Record<string, string> = {
  ...
  projectCode: '项目编码',
  projectName: '项目名称',
  projectStatusSnapshot: '项目状态快照',
  mainContractCode: '主合同编号',
  mainContractAmount: '主合同金额',
  targetVersionNo: '目标成本版本',
  targetAmount: '目标成本金额',
  batchCode: '批次编号',
  batchType: '批次类型',
  scopeKey: '范围',
  cutoffAt: '冻结基准',
  originalFactCount: '原事实数',
  changedFactCount: '变化数',
  unclassifiedCount: '待归类数',
  originalTotal: '原金额',
  targetType: '冲销对象类型',
  targetId: '冲销对象',
  reason: '原因',
  ...
  priority: '优先级',
  targetSubjectCode: '目标科目编码',
  targetSubjectName: '目标科目',
  subjectCode: '科目编码',
  subjectName: '科目名称',
  enabled: '调整结果',
  effectiveFrom: '生效日',
  effectiveTo: '失效日',
  impactSnapshot: '影响快照',
  oldSubjectCode: '原科目编码',
  oldSubjectName: '原科目',
  newSubjectCode: '新科目编码',
  newSubjectName: '新科目',
  sourceSubjectCode: '源科目编码',
  sourceSubjectName: '源科目',
  targetGroupCode: '归集组',
  mappingReason: '映射原因',
  factCount: '事实数',
  sourceCode: '来源编号',
