...
export const WORKFLOW_BUSINESS_TYPES = [
  ...
  ['PROJECT_PERIOD_PLAN', '项目年季月周计划'],
  ['PROJECT_CORRECTIVE_ACTION', '项目进度纠偏'],
  ['COST_CORRECTIVE_ACTION', '成本偏差纠偏'],
  ['TECHNICAL_SCHEME', '技术方案'],
  ['PROJECT_FINAL_ACCEPTANCE', '竣工验收'],
  ['QS_RECTIFICATION', '质量安全整改'],
  ['QS_CONSEQUENCE', '质量安全金额后果'],
  ['COST_RULE_PLAN', '成本规则方案'],
  ['COST_PROJECT_CONFIG', '项目成本配置'],
  ['COST_RECALCULATION', '历史成本重算'],
  ['COST_POST_CLOSE_ADJUSTMENT', '关闭后财务调整'],
  ['COST_REVERSAL', '成本冲销'],
