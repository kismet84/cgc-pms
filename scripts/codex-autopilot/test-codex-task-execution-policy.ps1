...
Assert-TextContains $ci @(
  ...
  'Git SSH','Accept-Ranges','256 KB','临时签名 URL'
) 'CI skill'
...
Assert-TextContains $policySuite @('test-codex-task-efficiency.ps1','test-codex-task-git-lifecycle.ps1','test-tool-routing.ps1','test-control-plane-fingerprint.ps1','test-mainline-owner-flow.ps1','Parameter(Mandatory)') 'Codex task policy suite'
