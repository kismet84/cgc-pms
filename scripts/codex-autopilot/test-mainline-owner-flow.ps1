...
foreach ($path in @($skillPath,$policyPath,$configPath)) {
...
foreach ($reference in @('AGENTS.override.md','AGENTS.md','scripts/codex-autopilot/codex-autopilot.config.json','plugins/cgc-pms-autopilot/references/control-plane-policy.md')) {
