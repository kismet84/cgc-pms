...
describe('Project overview mobile layout', () => {
  ...
  it('renders real project data in the compact mobile detail branch', () => {
    ...
    expect(overviewSource).toContain("const PROJECT_TYPE_DICT = 'project_type'")
    expect(overviewSource).toContain('fetchDictData(PROJECT_TYPE_DICT)')
    expect(overviewSource).not.toContain("CONSTRUCTION: '施工总承包'")
