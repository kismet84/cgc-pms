      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'subject',
            name: 'CostSubject',
            redirect: '/cost/subject/taxonomy',
            meta: { title: '成本科目中心' },
          },
          {
            path: 'subject/taxonomy',
            name: 'CostSubjectTaxonomy',
            component: () => import('@/pages/cost-subject/index.vue'),
            meta: { title: '成本科目体系' },
          },
          {
            path: 'subject/rules',
            name: 'CostSubjectRules',
            component: () => import('@/pages/cost-subject/index.vue'),
            meta: { title: '成本归集规则' },
          },
          {
            path: 'subject/scope',
            name: 'CostSubjectScope',
            component: () => import('@/pages/cost-subject/index.vue'),
            meta: { title: '项目适用成本科目' },
          },
          {
            path: 'subject/trace',
            name: 'CostSubjectTrace',
            component: () => import('@/pages/cost-subject/index.vue'),
            meta: { title: '成本科目影响与追踪' },
          },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: '费用申请', permission: 'expense:query' },
          },
        ],
      },
      {
        ...
        meta: { title: '项目预算', icon: 'CalculatorOutlined', permission: 'budget:query' },
      },
      {
        path: 'finance-operations',
        name: 'FinanceOperations',
        component: () => import('@/pages/finance-operations/index.vue'),
        meta: { title: '资金运营', icon: 'FundOutlined', permission: 'finance:operations:query' },
      },
      {
        path: 'revenue',
...
const ROUTE_PERMISSION_MAP: Record<string, string> = {
  ...
  CostSubjectTaxonomy: 'cost:query',
  CostSubjectRules: 'cost:subject:rule:query',
  CostSubjectScope: 'cost:subject:scope:query',
  CostSubjectTrace: 'cost:subject:audit:query',
